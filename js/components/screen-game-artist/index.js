...
import gameGenreScreen from '../screen-game-genre/index';

const screenTemplate = `
  <section id="game-artist" class="main main--level main--level-artist">
...
const gameArtistScreen = parseScreenFromTemplate(screenTemplate);

gameArtistScreen.addEventListener(`click`, switchScreen(`main-answer`, gameArtistScreen, gameGenreScreen));
